...
import { getCalculoEleccion, getCalculoTotalCoord, getCalculoTotalRef, getRecalculando, getvotosGrafica, getvotosGraficaEleccion } from '../../controllers/elecciones/graficas.controllers';
